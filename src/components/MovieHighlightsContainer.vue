    ...
    <div  class="w-full bg-gray-900 bg-opacity-95 px-4 py-8 mb-0">
        ...
        <div class="relative group">
            <div id="highlight-container" class="hide-scrollbar flex flex-none flex-row  overflow-x-scroll py-4 px-0 md:px-4 -mx-4">
                ...
                <div class="justify-between md:px-4 container mx-auto xl:w-10/12 hidden  group-hover:flex pointer-events-none absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
