        ...
        <div class="">
          ...
          <div class="flex">
            <div class="w-1/2 mr-2 flex flex-col my-3">
              <input v-model="filterMin" type="number" id="filter-start" class="border border-gray-200 rounded w-20 p-2 text-center h-10 text-black" min=1900 max=2010 :placeholder="$t('filter.from')" @input="scrollToTop">
            </div>
            <div class="w-1/2 mr-2 flex flex-col my-3">
              <input v-model="filterMax" type="number" id="filter-end" class="border border-gray-200 rounded w-20 p-2 text-center h-10 text-black" min=1900 max=2010 :placeholder="$t('filter.to')" @input="scrollToTop">  
            </div>
          </div>
        </div>
    </div>
