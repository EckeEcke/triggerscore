...
<div :class="{'bg-opacity-0': submitted}" class="w-full bg-gray-900 text-white rounded-b  lg:rounded-t">
    ...
    <div v-else class="mx-auto overflow-hidden">
        <h2 class="bg-red-900 bg-opacity-90 text-xl text-white py-4  lg:rounded-t" style="background-image: linear-gradient(rgba(220, 0, 0, 0.6), rgba(220, 0, 100, 0.6))" id="rating">{{ $t('rating.submitFor') }}<br><i class="font-semibold">"{{ title }}"</i></h2>
