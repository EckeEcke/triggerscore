      ...
      <section class="bg-white py-6 md:pt-4 md:pb-12 md:px-6 text-left text-sm mx-auto md:rounded flex flex-col lg:flex-row gap-x-12">
        <div class="w-full lg:w-1/2 px-4">
          ...
          <div class="flex justify-between items-center border-b border-gray-300 py-4 gap-4">
            <span class="lg:text-lg">{{ $t('stats.totalRatings') }}</span><span class="text-lg font-semibold h-14 flex items-center">{{ stats.totalRatings }}</span>
          </div>
          <div class="flex justify-between items-center border-b border-gray-300 py-4 gap-4">
            <span class="lg:text-lg">{{ $t('stats.moviesOnTS') }}</span><span class="text-lg font-semibold h-14 flex items-center">{{ stats.amountMovies }}</span>
          </div>
          <div class="flex justify-between items-center border-b border-gray-300 py-4 gap-4">
            <span class="lg:text-lg">{{ $t('stats.average') }} Triggerscore</span>
          ...
          <div class="flex justify-between items-center border-b border-gray-300 py-4 gap-4">
            <span class="lg:text-lg">{{ $t('stats.average') }} {{ $t('categories.sexism') }}</span>
          ...
          <div class="flex justify-between items-center border-b border-gray-300 py-4 gap-4">
            <span class="lg:text-lg">{{ $t('stats.average') }} {{ $t('categories.racism') }}</span>
          ...
          <div class="flex justify-between items-center border-b border-gray-300 py-4 gap-4">
            <span class="lg:text-lg">{{ $t('stats.average') }} {{ $t('categories.others') }}</span>
          ...
          <div class="flex justify-between items-center border-b border-gray-300 py-4 gap-4">
            <span class="lg:text-lg">{{ $t('stats.average') }} {{ $t('categories.cringe') }}</span>
