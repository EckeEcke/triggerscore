...
export default {
    ...
    methods: {
            mintrigger: function() {  
                if(this.minScore >= this.maxScore){this.minScore = this.maxScore}
                this.minthumb = ((this.minScore - this.min) / (this.max - this.min)) * 100;
            },
           
            maxtrigger: function() {
                if(this.maxScore >= this.max){this.maxScore = this.max}
                if(this.maxScore <= this.minScore){this.maxScore = this.minScore}
