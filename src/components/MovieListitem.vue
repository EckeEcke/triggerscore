<template>
    <router-link :to="{name: 'movie', params: {id: movie.id}}" tag="div" class="w-full h-44 bg-transparent text-white sm:border border-t border-b border-gray-700 shadow-md flex relative border-b md:rounded container-xl cursor-pointer">
