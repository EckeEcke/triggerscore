<template>
    <div class="relative flex align-center">
        <button v-if="$root.$i18n.locale == 'de'"  @click="showSelection = !showSelection" class="mr-6 sm:mr-10"><img class="w-6 h-4" src="../assets/images/germany.svg"></button>
        <button v-if="$root.$i18n.locale == 'en'"  @click="showSelection = !showSelection" class="mr-6 sm:mr-10"><img class="w-6 h-4" src="../assets/images/uk.svg"></button>
        <button v-if="$root.$i18n.locale == 'us'"  @click="showSelection = !showSelection" class="mr-6 sm:mr-10"><img class="w-6 h-4" src="../assets/images/usa.svg"></button>
        <button v-if="$root.$i18n.locale == 'fr'"  @click="showSelection = !showSelection" class="mr-6 sm:mr-10"><img class="w-6 h-4" src="../assets/images/france.svg"></button>
