...
<div class="sticky w-full h-0 z-50 top-0 left-0 -mt-14">
  <div class="relative">
    <div class="absolute bg-gray-900 bg-opacity-40 top-0 left-0 w-full h-screen overflow-none"  @click="$emit('close')"/>
              <div class="bg-gray-900 bg-opacity-80 backdrop-blur text-white shadow-lg w-72 min-w-10/12 p-4 right-0 absolute top-8 right-1 z-30 xl:hidden flex flex-col" style="height: calc(100vh - 4rem)">
