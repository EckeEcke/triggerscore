<template>
    <div class="bg-cover bg-center" :class="showTitle ? 'py-16 md:py-24' : 'py-8'"  :style="{ backgroundImage: 'linear-gradient(to bottom, rgba(47,27,27,0.6), rgba(67,27,27,0.7)),url(' + require('@/assets/images/backdrop-scarymovie.jpg') + ')'}">
