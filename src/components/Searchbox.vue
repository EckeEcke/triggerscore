<template>
    ...
    <div class="bg-top bg-fixed" :class="showTitle ? 'py-16 md:py-24' : 'py-8'"  :style="{ backgroundImage: 'linear-gradient(to bottom, rgba(153,27,27,0.6), rgba(153,27,27,0.7)),url(' + require('@/assets/images/backdrop-ballermann6.jpg') + ')'}">
